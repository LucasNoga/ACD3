...
public class Exercice1 extends JFrame {
	...
	public Exercice1(){
		...
		//D�clarations et initialisations des JLabel
		name = new JLabel("Nom");
		firstname = new JLabel("Prenom");

		//D�clarations et initialisations des JButton
		ok = new JButton("OK");
		...
		Athletisme = new JCheckBox("Athl�tisme");
		Foot = new JCheckBox("Foot");
		Randonnee = new JCheckBox("Randonn�e");
